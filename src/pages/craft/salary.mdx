...
description:
  "Redesigning the Estonian salary calculator"
role: ["UI design"]
date: October 2022
...
import initial from "@assets/salary/salary-calc-initial.png";
import second from "@assets/salary/salary-calc-second.png";
import cover from "@assets/salary/salary-calc-mockup.png";

<Image class="mb-8 aspect-video" src={cover} alt="A screenshot of the Estonian salary calculator." />

The goal of this project was for me to choose an application and redesign it, while keeping in mind the **basics of visual design**: typography, Gestalt principles, colors, and their use cases, etc. This project was one of the first thorough introductions to visual design that I had – I wrote down lots of notes and feel that I learned a lot.
...
<Image  src={initial} alt="Another screenshot of the initial iteration of the salary calculator, which is filled with data." />
...
<Image class="full-height" src={second} alt="The second iteration of the calculator with filled data" />
