...
<Image src={initiation} alt="A screen showing Notion used as a gallery of people with their countries and current positions." />
...
<Image src={ritual} alt="An iPhone screen showing a calendar event invitation." />
...
<Image src={getaway} alt="A poster informing the students about a getaway trip happening from the 17th to the 19th of May in 2025." />
