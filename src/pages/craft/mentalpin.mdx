...
import unboxing from '@assets/mental-pin/unboxing-example.png';
import onboarding from '@assets/mental-pin/mental-pin-onboarding.png';
import annotation from '@assets/mental-pin/mental-pin-annotation.png';
import aiexperience from '@assets/mental-pin/mental-pin-ai-experience.png';
import tasksandrewards from '@assets/mental-pin/mental-pin-tasks-and-rewards.png';
import cover from "@assets/mental-pin/mentalpin-cover.jpeg";

<Image class="mb-8 aspect-video" src={cover} alt="A man holding a phone in an airplane and logging his anxious airport episode." />
...
<Image class="inline" src={unboxing} alt="An unboxing experience for a physical journal." />
...
<Image class="inline" src={aiexperience} alt="A slide example from the presentation talking about the personalised AI experience." />

<Image class="inline" src={tasksandrewards} alt="A slide example from the presentation talking about the tasks and rewards system." />
...
<Image class="inline" src={onboarding} alt="A few screenshots from the application in the onboarding phase." />

And some screenshots from the episode annotation phase:

<Image class="inline" src={annotation} alt="A few screenshots from the application in the episode annotation phase." />
